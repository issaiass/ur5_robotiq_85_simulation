...
namespace ur5_robotiq_85_simulation {
...
PLUGINLIB_EXPORT_CLASS(ur5_robotiq_85_simulation::JointPositionController, controller_interface::ControllerBase);

} // namespace ur5_robotiq_85__simulation